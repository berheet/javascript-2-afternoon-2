...
/*
  ...
  Have divider return an Array with the first item in the array being the evens array (all the even values from numbersArray) and 
  the second item in the Array being the odds array (all the odd values from numbersArray).
*/
...
function divider(numbersArray){
  ...
  parentArray.push(evenArray)
  parentArray.push(oddArray)
...
/* 
  ...
  Above you're given a function that will return a random number between 0 and 30. There is also a commented out array full of numbers to help you 
  ...
  Loop through the array (that will be passed in as a parameter) to see if that random number 
  is in the array. 
...
/*
  ...
  In both the removeItem function and the addItem function, you will also need to check for
   valid aurguments. SpecRunner will try to call your functions without passing in valid 
   aurguments. 
...
function addTen(numbers){
  ...
  for(var i = 0; i < numbers.length; i++) {
    var numbers1 = Number(numbers[i]);
    var plusTen = numbers1 + 10;
    answer.push(plusTen)
  }
  return answer;
}
...
users.push({
  name: 'Drizzy Drake McGinnis',
  email: 'tylermcginnis33@gmail.com',
  password: 'iLoveJavaScript',
  username: 'infiniteLoop'
});
users.push({
  name: 'Phil COlloin McGinnis',
  email: 'tylermcginnis33@gmail.com',
  password: 'iLoveJavaScript',
  username: 'infiniteLoop'
});
...
/*
  ...
  Loop through your array of objects until you find Tyler's account (use tylermcginnis33@gmail.com to 
    find him).
